...
public class App {
	...
	private static void displayMenu() {
		...
		case 1:
			...
			if (id1.equals("1")) {
				System.out.println("한국에 대한 정보를 출력합니다.");
		...
		case 2:
			...
			if (id2.equals("1")) {
				...
				System.out.println(
						"유럽 중부에 있는 나라로, 여러 개의 독립국이 1871년 프로이센-프랑스전쟁을 거쳐 독일제국으로 성립되었다. 제2차 세계대전 후인 1949년 독일연방공화국(서독)과 독일민주공화국(동독)으로 나뉘었다가 1990년 통일되었다. 인구는 2020년 기준 약 8378만 명으로 유럽 전체에서 러시아와 터키에 이어 세 번째인 인구대국이다.");
			}
			if (id2.equals("2")) {
	...
	private static void ASIA() {
		System.out.println("아시아에 속한 국가목록을 출력합니다.");
	}

	private static void EUROPE() {
		System.out.println("유럽에 속한 국가목록을 출력합니다.");
	}
